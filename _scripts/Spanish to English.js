...
if (t != "") {
  location.href = "http://translate.google.com/translate_t?text=" + t + "&hl=en&langpair=es|en&tbb=1&ie=" + e;
} else {
  location.href = "http://translate.google.com/translate?u=" + escape(location.href) + "&hl=en&langpair=es|en&tbb=1&ie=" + e;
}
;
{{ endraw }}